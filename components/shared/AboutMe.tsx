    ...
    return (
        <section id="about" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                <h1 className="text-start text-6xl font-Space font-semibold text-black mt-5 mb-6">About Me</h1>
                ...
                <div className={`${styles.paragraph} max-w-full mt-5 font-Space leading-loose text-black space-y-3 text-lg`}>
                    <p>
                        ...
                        AI.
                        My decision to specialize in AI and ML comes from a profound belief in their transformative
                        power
                        🌟.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        natural language processing (NLP), and computer vision 🧠👁️. I envision a future where these
                        disciplines redefine technological innovation. Through hands-on projects and continuous learning
                        📚,
                        I strive to stay abreast of industry trends and contribute meaningfully to advancing
                        AI-driven solutions.
                    </p>
                    <p>
