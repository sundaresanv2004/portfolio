        ...
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <div className="flex flex-row justify-between items-center w-full">
                ...
                text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
                    ...
                    <span className="text-orange pl-0 lg:pl-8 md:pl-4 font-mono">Sundaresan V</span>{" "}
                </h1>

            </div>

            <p className={`${styles.paragraph} max-w-[650px] mt-5 pl-0 lg:pl-16 md:pl-8 font-mono text-xl text-muted-foreground`}>
